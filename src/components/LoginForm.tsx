  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100">
      <form onSubmit={handleSubmit(onSubmit)} className="bg-white p-6 rounded shadow-md w-full max-w-md">
        <h1 className="text-2xl font-bold mb-4 text-center text-button-primary">Login</h1>
        
        <div className="mb-4">
          <label className="block mb-1.5 text-xl text-text-primary">User Type</label>
          <Select
            value={userType}
            onValueChange={(value) => {
          ...
          >
            ...
            <SelectContent className="bg-white border-border-primary text-base">
              <SelectItem value="seller" className="text-base">Seller</SelectItem>
              <SelectItem value="customer"  className="text-base">Customer</SelectItem>
            </SelectContent>
          </Select>
        </div>

        <div className="mb-4">
          <label className="block mb-1.5 text-xl text-text-primary">Email</label>
          <input
            type="email"
        ...
        <div className="mb-6">
          <label className="block mb-1.5 text-xl text-text-primary">Password</label>
          <input
