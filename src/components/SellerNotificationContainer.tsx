...
import { SellerNotification } from "@/types/notificationTypes"; 
import { toTitleCase } from "@/lib/titleFormatHelper";

interface SellerNotificationContainerProps {
  notifications: SellerNotification[];
}

const SellerNotificationContainer: React.FC<SellerNotificationContainerProps> = ({ notifications }) => {
